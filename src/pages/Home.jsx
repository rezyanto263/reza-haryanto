...
export default function Home() {
  return (
    <div className="relative z-1 min-h-screen overflow-hidden bg-neutral-100 antialiased opacity-100 dark:bg-black dark:text-white">
      ...
      <div className="from-primary via-secondary fixed z-0 h-full w-full overflow-hidden bg-gradient-to-br from-0% via-30% to-transparent to-60% opacity-50 backdrop-blur-lg dark:opacity-10"></div>
      <Navbar />
